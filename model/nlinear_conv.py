...
class nlinear_conv(torch.nn.Module):
    def __init__(self, args):
        ...
        self.linear4 = torch.nn.Linear(self.input_size, self.input_size, bias=True)
        self.linear5 = torch.nn.Linear(self.input_size, self.output_size, bias=True)
        self.conv6 = cbs(self.input_dim, 4 * self.input_dim, 1, 1)
        self.conv7 = torch.nn.Conv1d(4 * self.input_dim, self.output_dim, kernel_size=1, stride=1)
