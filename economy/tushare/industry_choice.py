...
parser.add_argument('--industry', default='消费电子概念,鸿蒙概念,人工智能,网络安全,数据安全,芯片概念,无人驾驶,锂电池概念,高股息精选,多元金融,国企改革,跨境支付(CIPS),中俄贸易概念,文化传媒概念,黄金概念', type=str, help='|行业或概念，如"A,B,C"|')
