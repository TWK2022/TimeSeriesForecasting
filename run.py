...
parser.add_argument('--epoch', default=500, type=int, help='|训练总轮数(包含之前已训练轮数)|')
...
parser.add_argument('--lr_end_ratio', default=0.001, type=float, help='|最终学习率=lr_end_ratio*lr_start，基准为0.001|')
parser.add_argument('--lr_end_epoch', default=500, type=int, help='|最终学习率达到的轮数，每一步都调整，余玄下降法|')
